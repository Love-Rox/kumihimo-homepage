/**
 * The source the live editor opens with.
 *
 * Kept out of the editor module so importing it costs nothing until the editor itself is
 * fetched, and so the same text can be reused elsewhere without dragging the editor along.
 */
export const SAMPLE = `diagram "配信スタジオ 系統図" {
  direction: LR
}
